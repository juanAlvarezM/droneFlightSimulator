...
public class CameraFollow2 : MonoBehaviour {
	...
	void FixedUpdate() 
	{
		...
		transform.rotation = Quaternion.Euler(new Vector3(angle, ourDrone.GetComponent<DronMovement2>().currentYRotation+ rotacion, 0f));  // eliminar copia en DronMovementScript si se cambia el script
